...
import { EntityArrayResponseType, AreaSigService } from '../service/area-sig.service';
...
export class AreaSigComponent implements OnInit {
  ...
  delete(area: IAreaSig): void {
    const modalRef = this.modalService.open(AreaSigDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected fillComponentAttributesFromResponseBody(data: IAreaSig[] | null): IAreaSig[] {
    return data ?? [];
  }
