...
export class CodeSigComponent implements OnInit {
  ...
  delete(code: ICodeSig): void {
    const modalRef = this.modalService.open(CodeSigDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.codes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICodeSig[] | null): ICodeSig[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.codeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
