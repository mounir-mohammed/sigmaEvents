...
export class InfoSuppSigComponent implements OnInit {
  ...
  delete(infoSupp: IInfoSuppSig): void {
    const modalRef = this.modalService.open(InfoSuppSigDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.infoSupp = infoSupp;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.infoSupps = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInfoSuppSig[] | null): IInfoSuppSig[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.infoSuppService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
