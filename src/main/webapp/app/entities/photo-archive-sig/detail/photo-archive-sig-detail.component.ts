...
@Component({
  selector: 'sigma-photo-archive-sig-detail',
  templateUrl: './photo-archive-sig-detail.component.html',
})
export class PhotoArchiveSigDetailComponent implements OnInit {
