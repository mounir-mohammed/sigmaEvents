...
import ma.sig.events.service.CategoryQueryService;
import ma.sig.events.service.CategoryService;
...
/**
 * REST controller for managing {@link ma.sig.events.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
     ...
     *
     * @param categoryId the id of the categoryDTO to save.
    ...
    public ResponseEntity<CategoryDTO> updateCategory(
        ...
        if (!Objects.equals(categoryId, categoryDTO.getCategoryId())) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, categoryDTO.getCategoryId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CategoryDTO> partialUpdateCategory(
        ...
        log.debug("REST request to partial update Category partially : {}, {}", categoryId, categoryDTO);
        if (categoryDTO.getCategoryId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(categoryId, categoryDTO.getCategoryId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, categoryDTO.getCategoryId().toString())
        );
    }
